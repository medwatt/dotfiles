...
syn keyword 	vhdlKeyword	signal variable constant
syn keyword 	vhdlKeyword	type subtype
...
" operators
syn keyword	vhdlPrimitives	and nand or nor xor xnor
syn keyword	vhdlPrimitives	rol ror sla sll sra srl
syn keyword	vhdlPrimitives	mod rem abs not
